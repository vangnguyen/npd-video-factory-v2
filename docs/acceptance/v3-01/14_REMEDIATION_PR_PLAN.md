...
| 8 | V3-01-08 consolidation/RC gate | in progress from exact `b132e83`; docs/evidence only | identify conditional acceptance candidate, consolidate matrix/gaps/gates and define provider/staging/cost/rights plans; no functional fix | no status change; 007/009/016 remain blockers | new G-08 before merge; G-01 onward remain separate; G-09 before deploy; G-10/G-11 acceptance; G-12 verdict |
