...
| 14 | V3-01-13 evidence serialization remediation | branch `remediation/v3-01-13-evidence-serialization`; code commit `f04bffc`; draft/G-08 pending | canonical dataclass/Pydantic serializer, deterministic JSON/SHA, recorded-success writer and secret-free durable-context fallback; 0 calls/0 VND | 003/010/013 remain in progress; fixes future evidence path only | G-08 before merge; exact-main then RC-6 lock/new IDs/rebind and separate operation authority |
