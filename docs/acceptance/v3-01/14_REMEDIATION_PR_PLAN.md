...
| 10 | V3-01-10 verified acceptance gate loader | implementation in LOCAL/CI on branch `remediation/v3-01-10-verified-gate-loader`; G-08 pending | hash-pinned approval/rights bundle, exact RC, two-operation allowlist, atomic VND reservation, expiry and G-03-A candidate; 0 external calls | 003/010 remain in progress; no acceptance axis changes | new G-08 before merge; then exact-main regression, RC-3, G-03-A and exact RC-3 gate rebinding before any execution decision |
