...
| 13 | RC-5 Vision governance rebind | governance-only branch; G-08 pending | bind G-01-A/G-02-A/G-03-A, two derived operation IDs, exact asset/RightsRecord, VND envelope and dated execution-scope hash; bundle unmounted | 003/010/013 remain in progress; no acceptance axis changes | merge requires separate G-08; operation 1 requires another explicit owner decision |
