...
| 9 | V3-01-09 OpenAI Vision adapter | implementation/mock evidence on `fe4837b`; draft PR/G-08 pending | exact `gpt-5-mini` Responses adapter, bounded frame evidence, strict schema, hashes, VND receipt and fail-closed tests; 0 external calls | 003 moves from open to in progress; 010/013 unchanged | new G-08 before merge; if merged lock RC-2, then G-01-A/G-02-A/G-03-A separately before one call |
