...
| 3 | V3-01-03 ingress/media security and durable safety state | implementation in progress on isolated branch; draft PR allowed only | quarantine/malware/archive denial, WAF contract, PostgreSQL provider ledger, atomic reservation, durable circuit/recovery/retention metrics | 010 and 011 remain in progress | new G-08 before merge; G-04 before any staging/ingress; no real calls |
| 4 | V3-01-04 Flow A closure | planned; not started | owned media, real ASR/Vision/reframe and two consecutive runs | 003, 005, 016 plus production acceptance for 010/011 | G-01 through G-04 before real run; G-08 before merge; G-11 for quality |
| 5 | V3-01-05 Flow B closure | planned; not started | research/claims/originality, real media providers, rights and two consecutive runs | 002, 004, 005, 013, 016 | G-01 through G-04 as applicable; G-08 before merge; G-11 for quality |
