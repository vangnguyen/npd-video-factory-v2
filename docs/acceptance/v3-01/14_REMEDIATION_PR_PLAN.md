...
| 11 | V3-01-11 structured output/error evidence | IN PROGRESS on isolated draft branch; PR #25 evidence merge and `V3-01-APP-017` complete; new G-08 pending | required-nullable strict schema audit, redacted typed provider errors, durable attempt JSON and migration; 0 external calls/0 VND | 003/010 remain in progress; no acceptance axis changes | separate G-08 before merge; then exact-main regression, RC-4, new gate bundle and new operation IDs |
