...
G-00 and three completed bounded G-08 actions have approval records. All G-08 approvals are
...
| G-08 | remediation PR merge | CONSUMED — `V3-01-APP-002` completed PR #12 → retest #13 → PR #13; `V3-01-APP-003` completed PR #14; `V3-01-APP-004` completed PR #15 | a new explicit G-08 record is required for V3-01-04 or any later merge |
...
#12/#13 sequence and PR #14/#15 merges authorized by the three G-08 records are complete and cannot be reused. Current authority
...
[`V3-01-APP-004`](approvals/V3-01-APP-004.json).
