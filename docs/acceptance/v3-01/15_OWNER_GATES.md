...
G-00 and eight completed bounded G-08 actions have approval records. All G-08 approvals are
consumed; V3-01-09 needs a new G-08 and every runtime gate remains `PENDING`. Use
...
| G-08 | remediation PR merge | CONSUMED — `V3-01-APP-002` completed PR #12/#13; `V3-01-APP-003` through `V3-01-APP-009` completed PR #14 through PR #20 | a new explicit G-08 record is required for V3-01-09 or any later merge |
...
#12/#13 sequence and PR #14/#15/#16/#17/#18/#19/#20 merges authorized by the eight G-08 records are complete and cannot be reused. Current authority
