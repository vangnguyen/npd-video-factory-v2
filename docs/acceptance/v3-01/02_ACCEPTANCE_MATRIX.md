...
provenance confirmed identical executable trees. A separately authorized RC-10 operation 1 then
completed with strict structured output, complete hashes/usage/VND evidence, one attempt, no
retry/fallback and a clean secret scan. It is a real-provider PASS for the operation and is
consumed. Vision remains 1/2 consecutive PASS, so the aggregate `VIS-01` real-provider column stays
`NOT_TESTED`; Operation 2 remains not approved/locked. `I/M/R/P/Q` mean
...
| OPS-04 | Rights and provenance ledger | PASS | PASS | NOT_TESTED | NOT_TESTED | NOT_TESTED | EV-V3-STATIC-001; EV-V3-CI-001; EV-V3-PROVIDER-SAFETY-001; EV-V3-FLOW-B-CONTRACT-001; EV-V3-VERIFIED-GATE-LOADER-001; EV-V3-OPENAI-VISION-OP1-FAILED-001; EV-V3-RC5-VISION-OP1-REVIEW-001; EV-V3-RC10-VISION-OP1-PASS-001 | GAP-013 |
...
| OPS-09 | Audit/evidence retention | PASS | PASS | N/A | NOT_TESTED | N/A | EV-V3-STATIC-001; EV-V3-DR-OBS-001; EV-V3-RC5-VISION-OP1-REVIEW-001; EV-V3-EVIDENCE-SERIALIZATION-001; EV-V3-RC10-VISION-OP1-PASS-001 | GAP-009; GAP-013 |
