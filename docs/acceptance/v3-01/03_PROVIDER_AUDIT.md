...
PR #48 merged that remediation as locked RC-14
`0b0965c650f4d06a057acbbb1a7ed9d7b933478b` after exact-head and exact-main CI passed 5/5. Its fresh
...
it makes zero calls/credential reads/reservations/spend and leaves ASR real-provider `NOT_TESTED`.
PR #48 and exact-main CI then locked `vf-v3-01-rc14`; `EV-V3-RC14-ASR-GATE-001` validates only the
